...
* [myphysicslab](https://github.com/myphysicslab/myphysicslab) ⭐ 441 | 🐛 2 | 🌐 TypeScript | 📅 2024-11-25 - provides JavaScript classes to build real-time interactive animated physics simulations
...
* [pycbc](https://github.com/ligo-cbc/pycbc) ⭐ 387 | 🐛 240 | 🌐 Python | 📅 2026-08-12 - Analyze gravitational-wave data, find signals, and study their parameters
...
* [meep](https://github.com/stevengj/meep) ⭐ 1,737 | 🐛 375 | 🌐 C++ | 📅 2026-08-09 - Free finite-difference time-domain (FDTD) software for electromagnetic simulations
* [scikit-rf](https://github.com/scikit-rf/scikit-rf) ⭐ 923 | 🐛 53 | 🌐 Python | 📅 2026-08-09 - RF and Microwave Engineering Scikit
* [gprMax](https://github.com/gprMax/gprMax) ⭐ 870 | 🐛 94 | 🌐 Python | 📅 2026-08-12 - Simulates electromagnetic wave propagation using the Finite-Difference Time-Domain (FDTD) method for numerical modelling of Ground Penetrating Radar (GPR)
* [openEMS](https://github.com/thliebig/openEMS) ⭐ 708 | 🐛 9 | 🌐 C++ | 📅 2026-08-10 - A free and open-source electromagnetic field solver using the EC-FDTD method
* [PlasmaPy](https://github.com/PlasmaPy/PlasmaPy) ⭐ 704 | 🐛 352 | 🌐 Python | 📅 2026-08-11 - A community developed python package for plasma physics in the very early stages of development.
...
* [openmeeg](https://github.com/openmeeg/openmeeg) ⭐ 87 | 🐛 56 | 🌐 C++ | 📅 2026-08-10 - A C++ package for low-frequency bio-electromagnetism solving forward problems in the field of EEG and MEG
...
* [odak](https://github.com/kunguz/odak) ⭐ 214 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - A fundamental library for scientific computing in optical sciences.
* [poppy](https://github.com/mperrin/poppy) ⭐ 190 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2026-08-10 - Physical Optics Propagation in Python
...
* [QuantumOptics.jl](https://github.com/qojulia/QuantumOptics.jl) ⭐ 619 | 🐛 58 | 🌐 Julia | 📅 2026-08-11 - Library for the numerical simulation of closed as well as open quantum systems
...
* [simpeg](https://github.com/simpeg/simpeg) ⭐ 666 | 🐛 186 | 🌐 Python | 📅 2026-08-13 - Simulation and Parameter Estimation in Geophysics - A python package for simulation and gradient based parameter estimation in the context of geophysical applications
...
* [em](https://github.com/geoscixyz/em) ⭐ 80 | 🐛 66 | 🌐 HTML | 📅 2025-02-06 - Electromagnetic methods in geophysics - open educational resources
